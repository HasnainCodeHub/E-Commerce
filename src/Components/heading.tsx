...
export  default function Heading (){
    return(
        <main>
            ...
            <h1 className="font-bold text-6xl ">My E Commerce Store</h1>
            <p className="py-14 px-20 font-serif text-4xl">Discover a diverse range of products designed to meet all your needs. Our store features a curated selection of high-quality items across various categories, including fashion, electronics, home goods, and health & beauty. Each product is carefully sourced to ensure superior quality and value. <br />
            <br />
